const iniState = {
  post: [
    { id: 1, src: "./img/lady.jpg",title: "something", content: "there should be something here though, I just don't know what to write here, oh well, It's just for testing purposes"},
